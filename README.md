...
- **Repository Factory**: Automated repository creation with proper classification
...
├── repositoryFactory.md   # Automated repository creation guide
...
```
See [Repository Factory Documentation](docs/repositoryFactory.md) for complete usage guide.
...
### Automation
- [**Repository Factory**](docs/repositoryFactory.md) - Automated repository creation
- [**Lessons Automation**](docs/lessonsAutomation.md) - Learning extraction and application

## 🛠️ Usage

### For Organization Members
1. **Creating Repositories**: Use the Repository Factory via slash commands
...
### Repository Factory (`scripts/repo_factory.py`)
...
- **Repository Creation Issues**: See [Repository Factory Documentation](docs/repositoryFactory.md)
